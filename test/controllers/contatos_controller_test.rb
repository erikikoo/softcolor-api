...
class ContatosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contato" do
    assert_difference('Contato.count') do
      post contatos_url, params: { contato: { bairro: @contato.bairro, cidade: @contato.cidade, endereco: @contato.endereco, estado: @contato.estado, numero: @contato.numero } }, as: :json
    end
  ...
  test "should update contato" do
    patch contato_url(@contato), params: { contato: { bairro: @contato.bairro, cidade: @contato.cidade, endereco: @contato.endereco, estado: @contato.estado, numero: @contato.numero } }, as: :json
    assert_response 200
  end
